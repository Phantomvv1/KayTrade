...
func NewRouter() *gin.Engine {
	...
	r.GET("/users/alpaca", AuthMiddleware, AdminOnlyMiddleware, GetAllUsersAlpaca)
	r.PATCH("/users/:id", AuthMiddleware, JSONParserMiddleware, UpdateUser)
	r.PATCH("/users/:id/alpaca", AuthMiddleware, UpdateUserAlpaca)
