...
func NewRouter() *gin.Engine {
	...
	watch.POST("", watchlist.CreateWatchlist)
	watch.GET("", watchlist.GetWatchlist)
	watch.GET("/:watchlistId", watchlist.ManageWatchlist)
	watch.PUT("/:watchlistId", watchlist.UpdateWatchlist)
	watch.DELETE("/:watchlistId", watchlist.DeleteWatchlist)
	watch.POST("/:watchlistId", watchlist.AddAssetWatchlist)
	watch.DELETE("/:watchlistId/:symbol", watchlist.RemoveSymbolFromWatchlist)
	...
	go hub.Run()
	data.GET("/stocks/live", func(c *gin.Context) {
