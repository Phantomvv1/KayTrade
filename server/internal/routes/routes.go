...
func NewRouter() *gin.Engine {
	...
	r.POST("/log-in", LogIn)
	r.GET("/users", AuthMiddleware, GetUser)
	r.GET("/users/alpaca", AuthMiddleware, GetUserAlpaca)
	r.GET("/users/all", AuthMiddleware, AdminOnlyMiddleware, GetAllUsers)
	r.GET("/users/all/alpaca", AuthMiddleware, AdminOnlyMiddleware, GetAllUsersAlpaca)
	r.PATCH("/users", AuthMiddleware, JSONParserMiddleware, UpdateUser)
	r.PATCH("/users/alpaca", AuthMiddleware, UpdateUserAlpaca)
	r.DELETE("/users", AuthMiddleware, DeleteUser)
